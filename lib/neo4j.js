...
exports.initialize = function (dataSource, cb) {
    ...
    // according to docs
    // https://github.com/strongloop/loopback-datasource-juggler/blob/master/docs/datasource-connector.md#interaction-between-datasource-and-connector
    // the connector should create a reference to the dataSource
    var connector = new Neo4j(db);
...
neo4j.destroyAll = function (model, cb){
